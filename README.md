...
This repo contains the model and the parameters used for the manuscript "Automated beam-angle optimisation in IMPT comparing patient-specific deep learning predictions versus population-based class solution" in the journal phiRO (DOI:).
